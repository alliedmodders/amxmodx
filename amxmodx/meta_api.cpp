...
cvar_t init_amxmodx_perfmon = { "amx_perfmon", "1", FCVAR_SPONLY };
cvar_t init_amxmodx_perfmon_ms = { "amx_perfmon_ms", "5.0", FCVAR_SPONLY };

cvar_t* amxmodx_version = NULL;
cvar_t* amxmodx_modules = NULL;
cvar_t* amxmodx_debug = NULL;
cvar_t* amxmodx_language = NULL;
cvar_t* amxmodx_perfmon = NULL;
cvar_t* amxmodx_perfmon_ms = NULL;
...
C_DLLEXPORT	int	Meta_Attach(PLUG_LOADTIME now, META_FUNCTIONS *pFunctionTable, meta_globals_t *pMGlobals, gamedll_funcs_t *pGamedllFuncs)
{
	...
	CVAR_REGISTER(&init_amxmodx_perfmon);
	CVAR_REGISTER(&init_amxmodx_perfmon_ms);
	...
	amxmodx_perfmon = CVAR_GET_POINTER(init_amxmodx_perfmon.name);
	amxmodx_perfmon_ms = CVAR_GET_POINTER(init_amxmodx_perfmon_ms.name);
