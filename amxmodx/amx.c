...
//#if !defined __linux__  /* Linux GCC already has these types */
...
#define NUMENTRIES(hdr,field,nextfield) (int)(((hdr).nextfield - (hdr).field)/sizeof(AMX_FUNCSTUB))
...
int AMXAPI amx_Callback(AMX *amx, cell index, cell *result, cell *params)
{
  ...
  assert(index<(cell)NUMENTRIES(*hdr,natives,libraries));
...
static void *labels[] = {
        ...
        &&op_swap_alt,  &&op_pushaddr,  &&op_nop    /*, &&op_calln*/ };
  AMX_HEADER *hdr;
  AMX_FUNCSTUB *func;
  u_char *code, *data;
 ...
 //   return AMX_ERR_INIT;
  ...
  op_retn:
    ...
    NEXT(cip);
  op_call:
    PUSH(((u_char *)cip-code)+sizeof(cell));    /* push address behind instruction */
...
//  NEXT(cip);
 ...
 //   } /* if */
   ...
   */
    ...
    #if defined amx_Init && !defined STACKARGS  /* for AMX32.DLL */
