...
static cell AMX_NATIVE_CALL set_hudmessage_ex(AMX *amx, cell *params) /* 14 param */
{
	g_hudset.a1 = 0;
	g_hudset.a2 = 0;
	g_hudset.r1 = static_cast<byte>(params[1]);
...
AMX_NATIVE_INFO amxmodx_Natives[] =
{
	...
	{"set_dhudmessage_ex",		set_dhudmessage},
	{"set_hudmessage_ex",		set_hudmessage},
